...
public class VerifyNumberWhileCreatingAccount extends AppCompatActivity {
        ...
        public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
            ...
            verificationInProgress = true;
                ...
                public void onVerificationCompleted(@NonNull PhoneAuthCredential phoneAuthCredential) {
                    ...
                    Log.e("Verifying : ","onVerfifcationcomplete");
                ...
                public void onVerificationFailed(@NonNull FirebaseException e) {
                    ...
                    Log.e("Verifying : ","onVerfifcationincomplete");
                    Toast.makeText(
                            getApplicationContext(),
                            "Failed",
                            Toast.LENGTH_SHORT
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.verifiy_number_while_creting_account);
